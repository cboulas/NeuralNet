...
{
    public class Synapse : Interfaces.ISynapse
    {
        internal Interfaces.INeuron _fromNeuron;
        ...
        public Synapse(Interfaces.INeuron fromNeuraon, Interfaces.INeuron toNeuron, double weight)
        {
        ...
        public Synapse(Interfaces.INeuron fromNeuraon, Interfaces.INeuron toNeuron)
        {
            _fromNeuron = fromNeuraon;
            _toNeuron = toNeuron;
