...
namespace NeuralNet
{
    ...
    {
        private Factory.NeuralLayerFactory _layerFactory;

        internal List<Classes.NeuralLayer> _layers;
        ...
        {
            _layers = new List<Classes.NeuralLayer>();
            _layerFactory = new Factory.NeuralLayerFactory();
        ...
        /// </summary>
        public void AddLayer(Classes.NeuralLayer newLayer)
        {
            if (_layers.Any())
            {
        ...
        {
            var inputLayer = _layerFactory.CreateNeuralLayer(numberOfInputNeurons, new Classes.RectifiedActivationFuncion(), new Classes.WeightedSumFunction());
